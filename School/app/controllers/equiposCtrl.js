angular.module("school").controller("equiposCtrl", ["$scope", "$http", "notify", "sweetAlert", equiposCtrl]);


function equiposCtrl($scope, $http, notify, sweetAlert) {
    vm = this;
