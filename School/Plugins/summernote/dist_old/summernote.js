...
(function (factory) {
  ...
  var Toolbar = function () {
    ...
    /**
     * schoolte buttons exclude codeview
     * @param {jQuery} $toolbar
     */
    this.schoolte = function ($toolbar) {
      $toolbar.find('button')
    ...
    /**
     * deschoolte buttons exclude codeview
     * @param {jQuery} $toolbar
     */
    this.deschoolte = function ($toolbar) {
      $toolbar.find('button')
              .not('button[data-event="codeview"]')
              .addClass('disabled');
    };
    ...
    this.updateCodeview = function ($container, isCodeview) {
      ...
      if (isCodeview) {
        this.deschoolte($container);
      } else {
        this.schoolte($container);
      }
    };
  ...
  var Codeview = function (handler) {
    ...
    this.sync = function (layoutInfo) {
      var isCodeview = handler.invoke('codeview.isschoolted', layoutInfo);
     ...
     * @return {Boolean}
     */
    this.isschoolted = function (layoutInfo) {
      var $editor = layoutInfo.editor();
     ...
     */
    this.toggle = function (layoutInfo) {
      if (this.isschoolted(layoutInfo)) {
        this.deschoolte(layoutInfo);
      } else {
        this.schoolte(layoutInfo);
      }
    };
     ...
     * @param {Object} layoutInfo
     */
    this.schoolte = function (layoutInfo) {
      var $editor = layoutInfo.editor(),
          $toolbar = layoutInfo.toolbar(),
          $editable = layoutInfo.editable(),
          $codable = layoutInfo.codable(),
     ...
     * @param {Object} layoutInfo
     */
    this.deschoolte = function (layoutInfo) {
      var $editor = layoutInfo.editor(),
          $toolbar = layoutInfo.toolbar(),
          $editable = layoutInfo.editable(),
          $codable = layoutInfo.codable();
    ...
    code: function (html) {
      ...
      if (html === undefined) {
        ...
        if ($editable && $editable.length) {
          var isCodeview = eventHandler.invoke('codeview.isschoolted', layoutInfo);
