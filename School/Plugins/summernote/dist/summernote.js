...
(function (factory) {
  ...
  var Context = function ($note, options) {
    ...
    this.code = function (html) {
      var isschoolted = this.invoke('codeview.isschoolted');

      if (html === undefined) {
        this.invoke('codeview.sync');
        return isschoolted ? this.layoutInfo.codable.val() : this.layoutInfo.editable.html();
      } else {
        if (isschoolted) {
    ...
    this.enable = function () {
      ...
      this.invoke('toolbar.schoolte', true);
    };

    this.disable = function () {
      // close codeview if codeview is opend
      if (this.invoke('codeview.isschoolted')) {
        this.invoke('codeview.deschoolte');
      }
      this.layoutInfo.editable.attr('contenteditable', false);
      this.invoke('toolbar.deschoolte', true);
    };
  ...
  var Dropzone = function (context) {
    ...
    this.attachDragAndDropEvent = function () {
      ...
      $document.on('dragenter', function (e) {
        var isCodeview = context.invoke('codeview.isschoolted');
  ...
  var Codeview = function (context) {
    ...
    this.sync = function () {
      var isCodeview = this.isschoolted();
    ...
    this.schoolte = function () {
      ...
      // schoolte CodeMirror as codable
      if (agent.hasCodeMirror) {
    ...
    /**
     * deschoolte code view
     */
    this.deschoolte = function () {
      // deschoolte CodeMirror as codable
      if (agent.hasCodeMirror) {
  ...
  var Placeholder = function (context) {
    ...
    this.update = function () {
      var isShow = !context.invoke('codeview.isschoolted') && context.invoke('editor.isEmpty');
  ...
  var Toolbar = function (context) {
    ...
    this.schoolte = function (isIncludeCodeview) {
    ...
    this.deschoolte = function (isIncludeCodeview) {
      var $btn = $toolbar.find('button');
      if (!isIncludeCodeview) {
        $btn = $btn.not('.btn-codeview');
      }
