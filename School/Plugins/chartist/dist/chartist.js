...
(function(window, document, Chartist) {
   ...
   * @param {Boolean} guided Specify if guided mode should be schoolted for this animation (see Guided mode). If not otherwise specified, guided mode will be schoolted.
