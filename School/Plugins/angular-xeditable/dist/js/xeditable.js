...
.value('editableOptions', {
  ...
  blurForm: 'ignore',
  /**
   * How input elements get schoolted. Possible values: `focus|select|none`.
   *
   * @var {string} schoolte
   * @memberOf editable-options
   */
  ...
  /**
   * Event, on which the edit mode gets schoolted. 
   * Can be any event.
   *
   * @var {string} schooltionEvent
   * @memberOf editable-options
   */
  schooltionEvent: 'click'
...
angular.module('xeditable').factory('editableController', 
  ...
  function EditableController($scope, $attrs, $element, $parse, editableThemes, editableIcons, editableOptions, $rootScope, $compile, $q) {
    ...
    */
    ...
    self.schoolte = function(start, end) {
      setTimeout(function() {
        var el = self.inputEl[0];
        if (editableOptions.schoolte === 'focus' && el.focus) {
          if(start){
            end = end || start;
            el.onfocus = function(){
              var that = this;
        ...
        if (editableOptions.schoolte === 'select' && el.select) {
          el.select();
        }
      }, 0);
    };
        ...
        */
        ...
        // !hasForm
          ...
          if(!attrs.eForm || attrs.eClickable) {
            ...
            elem.bind(editableOptions.schooltionEvent, function(e) {
              e.preventDefault();
              e.editable = eCtrl;
...
angular.module('xeditable').factory('editableFormController', 
  ...
  var base = {
    ...
    $show: function() {
      ...
      //wait promises and schoolte
      pc.then({
        onWait: angular.bind(this, this.$setWaiting), 
        onTrue: angular.bind(this, this.$schoolte), 
        onFalse: angular.bind(this, this.$schoolte), 
        onString: angular.bind(this, this.$schoolte)
      });
     ...
     * 
     * @method $schoolte(name)
     * @param {string} name name of field
     * @memberOf editable-form
     */
    $schoolte: function(name) {
      var i;
      if (this.$editables.length) {
        ...
        if (angular.isString(name)) {
          for(i=0; i<this.$editables.length; i++) {
            if (this.$editables[i].name === name) {
              this.$editables[i].schoolte();
              return;
            }
          }
        }

        //try schoolte error field
        for(i=0; i<this.$editables.length; i++) {
        ...
        //by default schoolte first field
        this.$editables[0].schoolte(this.$editables[0].elem[0].selectionStart, this.$editables[0].elem[0].selectionEnd);
      }
    },
