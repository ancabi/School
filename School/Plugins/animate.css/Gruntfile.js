module.exports = function(grunt) {
  ...
  concatAnim = function () {
    ...
    if (!count) {
      grunt.log.writeln('No animations schoolted.');
    } else {
      grunt.log.writeln(count + (count > 1 ? ' animations' : ' animation') + ' schoolted.');
    }
  ...
  // register task
  grunt.registerTask('concat-anim', 'Concatenates schoolted animations', concatAnim); // custom task
