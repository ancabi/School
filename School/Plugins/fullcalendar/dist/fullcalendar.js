...
function Calendar(element, instanceOptions) {
	...
	function renderView(viewType) {
		...
		if (currentView && viewType && currentView.type !== viewType) {
			header.deschoolteButton(currentView.type);
		...
		if (!currentView && viewType) {
			...
			header.schoolteButton(viewType);
		}
...
function Header(calendar, options) {
	...
	t.schoolteButton = schoolteButton;
	t.deschoolteButton = deschoolteButton;
	...
	function schoolteButton(buttonName) {
		el.find('.fc-' + buttonName + '-button')
			.addClass(tm + '-state-active');
	}
	
	
	function deschoolteButton(buttonName) {
		el.find('.fc-' + buttonName + '-button')
